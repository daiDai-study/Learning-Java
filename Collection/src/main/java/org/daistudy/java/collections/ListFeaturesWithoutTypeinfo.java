...
// collections/ListFeaturesWithoutTypeinfo.java
//import typeinfo.pets.*;
import java.util.*;

class Pets{
    static List<Pet> list(int number){
...
class Pet implements Comparable{
    ...
    public int compareTo(Object o) {
        return this.getClass().getSimpleName().compareToIgnoreCase(o.getClass().getSimpleName());
    }
}
...
/**
 * subList() 所产生的列表的幕后支持就是原始列表：对所返回列表的更改都将会反映在原始列表中，反之亦然。
 */
public class ListFeaturesWithoutTypeinfo {
