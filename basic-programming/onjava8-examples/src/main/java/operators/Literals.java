...
public class Literals {
  public static void main(String[] args) {
    ...
    // 自定义的
//    float f11 = 1.0; // 编译不通过，需要强制转换
    float f21 = 1.0F; // float suffix
    float f31 = 1.0f; // float suffix
    double d11 = 1.0; // 编译不通过，说明 默认的小数（字面值常量）为 双精度浮点型
    double d21 = 1.0d; // double suffix
    double d31 = 1.0D; // double suffix

    // 默认整数的（字面值常量）为整型，如果赋值其他的整型，会自动截断，不需要强制转换
    int i11 = 1;
    short s11 = 1;
    long l11 = 1;
    char c11 = 1;
